...
@st.cache_data
def create_bar_chart(data, x, y, title, color=None, orientation='v', color_map=None, color_map1=None, text_auto=True):
    """
...
@st.cache_data
def create_line_chart(data, x, y, title, color=None, color_map=None, color_map1=None):
    """
